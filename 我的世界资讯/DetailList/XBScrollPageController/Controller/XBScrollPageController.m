...
- (void)setupDefaultProperties
{
    ...
    self.selectedTitleFont = [UIFont systemFontOfSize:17];
    // 未选中颜色
    ...
    // page下标
    self.selectedIndicatorColor = [UIColor clearColor];
...
- (void)setupCollectionView
{
    ...
    // 最底层View的颜色
    pageCollectionView.backgroundColor = [UIColor lightGrayColor];
